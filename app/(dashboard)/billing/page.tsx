...
import { GetUserPurchaseHistroy } from "@/actions/billing/getUserPurchaseHistroy";
...
async function TransactionHistroyCard() {
  const purchases = await GetUserPurchaseHistroy();
  return (
    <Card>
      <CardHeader>
